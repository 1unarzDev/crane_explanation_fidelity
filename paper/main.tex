...
P again failed exact verification and fell back to T (7/7 development questions). These are
project-review observations awaiting blinded annotation, not scored outcomes.
...
two development cases were selected to exercise the pipeline; only the separately frozen
