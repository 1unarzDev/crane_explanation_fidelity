...
| Land command--motion physical/reference cohort progress and bounded findings | `manifests/data/cm-land-conf-001-disposition.json` through `manifests/data/cm-land-conf-038-disposition.json` | Thirty-eight of 100 fixed confirmation configurations attempted: 37 valid and one retained invalid transport recording; runs 003, 006, 018, 028, and 029 are mechanism-insufficient after independently configured odometry masks while retaining execution facts; runs 004, 008, 011, 015, 016, 024, 026, 031, 035, 037, and 038 record recovered measured response followed respectively by abort and ten successes; runs 005, 007, 012, 013, 033, and 036 are nominal `not_triggered` controls; runs 009, 010, 014, 017, 019, 020, 021, 022, 023, 025, 027, 030, and 032 are persistent discrepancies followed by abort; run 034 failed the frozen stale/rejected-action validity gate and contributes no diagnostic or semantic result |
