...
| Final Luna v4-high development and fresh held-out qualification | `manifests/annotation/luna-model-judge-v1-development-v4-high.json` and `manifests/annotation/luna-model-judge-v1-heldout-v4-high.json` | Direct pass-specific false-rejection, unit, and core-field counts; both held-out passes failed predeclared gates |
