...
| Active Luna v12 endpoint-aligned held-out qualification | `manifests/annotation/luna-model-judge-v1-heldout-v12-final.json` and `research/explanation_fidelity/experiment_configs/prospective/diagnostic-sequential-protocol-v2-annotation-amendment-4.json` | Both passes: 8/8 endpoint and 28/28 binary unit-coverage decisions, zero material false rejection/acceptance and protected/call failures; core fields 117/120 and 119/120; eight-case zero-error Wilson 95% upper bound approximately 0.3244; zero study responses and alpha |
| Land command--motion physical/reference cohort progress and bounded findings | `manifests/data/cm-land-conf-001-disposition.json` through `manifests/data/cm-land-conf-040-disposition.json` | Forty of 100 fixed confirmation configurations attempted: 39 valid and one retained invalid transport recording; runs 003, 006, 018, 028, and 029 are mechanism-insufficient after independently configured odometry masks while retaining execution facts; runs 004, 008, 011, 015, 016, 024, 026, 031, 035, and 037--039 record recovered measured response followed respectively by abort and eleven successes; runs 005, 007, 012, 013, 033, and 036 are nominal `not_triggered` controls; runs 009, 010, 014, 017, 019, 020, 021, 022, 023, 025, 027, 030, 032, and 040 are persistent discrepancies followed by abort; run 034 failed the frozen stale/rejected-action validity gate and contributes no diagnostic or semantic result |
