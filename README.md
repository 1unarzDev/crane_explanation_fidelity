...
- **PHYSICAL/REFERENCE COLLECTION ACTIVE; SEMANTIC CAMPAIGN INACTIVE:** twelve of the frozen 100
  ...
  run 012 adds a nominal `not_triggered` control despite recovery activity.
