...
- **PHYSICAL/REFERENCE COLLECTION ACTIVE; SEMANTIC CAMPAIGN INACTIVE:** thirty-eight of the frozen 100
  land command--motion confirmation configurations have been attempted once: thirty-seven are
  ...
  19--29 s, measured-response recovery from 31--32 s, and eventual success. Fixed run 039 is next.
