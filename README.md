...
- **PHYSICAL/REFERENCE COLLECTION ACTIVE; SEMANTIC CAMPAIGN INACTIVE:** twenty-nine of the frozen 100
  ...
  independently configured missing-odometry case with the same bounded withholding result.
