...
| TurtleBot3 warehouse/industrial | Manifest-driven 20 × 26 m canonical geometry, separate presentation, semantic/route IDs, differential robot and LiDAR | Historical short Nav2 smoke passed; v2 headless cross-aisle calibration has valid transport/costmaps but timed out twice | No ecological explanation evaluation yet | **REQUIRED — active ecological development; v2 navigation pass not established** |
