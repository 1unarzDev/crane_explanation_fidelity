...
| TurtleBot3 warehouse/industrial | CRANE-owned primitive canonical geometry, separate presentation, semantic IDs, differential robot and LiDAR | Headless structure/physics and a short Nav2 success smoke | No ecological explanation evaluation yet | **REQUIRED — active ecological development** |
