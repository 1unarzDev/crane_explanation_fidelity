...
| TurtleBot3 warehouse/industrial | Manifest-driven 20 × 26 m canonical geometry, separate presentation, semantic/route/scenario IDs, deterministic static/delayed/temporary obstacles, differential robot and LiDAR | Structural/physics/sensor/headless gates; 13.61 m nominal detour; exact bounded-policy pair produced 53.38 s success versus 71.10 s BT-deadline abort under complete blockage; isolated inspection passed | Task-deadline provenance and scenario identities are QA-ready; no physical-cause or recovery-attempt claim is made | **REQUIRED — active ecological development; nominal and terminal-policy cases pass, genuine recovery case incomplete** |
