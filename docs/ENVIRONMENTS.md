...
| TurtleBot3 warehouse/industrial | Manifest-driven 20 × 26 m canonical geometry, separate presentation, semantic/route IDs, differential robot and LiDAR | Structural/physics/sensor/headless gates plus one 13.61 m west-aisle detour pass; isolated overview/oblique/HUD/semantic/collider inspection passed, manual keyboard and failure/recovery remain | Nominal scenario is evidence-ready; ecological explanation evaluation not yet run | **REQUIRED — active ecological development; nominal route ready, suite incomplete** |
