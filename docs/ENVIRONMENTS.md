...
| TurtleBot3 warehouse/industrial | Manifest-driven 20 × 26 m canonical geometry, separate presentation, semantic/route/scenario IDs, deterministic static/delayed/temporary obstacles and a temporary four-wall enclosure, differential robot and LiDAR | Structural/physics/sensor/headless gates; 13.61 m nominal detour; exact bounded-policy pair produced 53.38 s success versus 71.10 s BT-deadline abort under complete blockage; temporary enclosure passed 3/3 exact-condition recovery-success repetitions; isolated inspection passed | Task-policy provenance, recovery mechanisms, scenario/route/obstacle identities, evaluator-only wall timing, and delivered trajectory are QA-ready; explanation generation/annotation remains `NOT_RUN`, recovery-count variability is retained, and no physical-cause claim is made | **REQUIRED — active ecological development; priority recovery mechanism repeated, scenario-to-question contracts open** |
