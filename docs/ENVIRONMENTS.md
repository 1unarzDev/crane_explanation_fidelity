...
| Configurable land proving ground | Manifest-driven eight-motif generator with separate canonical/presentation layers, seeded configuration hashes, semantic IDs, evaluator truth, dynamic schedules, dedicated Nav2 parameters, inspection overlays, and hash-checking behavioral QA | Structural/physics/sensor/headless/explanation checks pass; all eight motifs have one behaviorally qualified development revision across preserved v1 plus the additive v2 slalom; the straight-through v1 slalom remains a negative calibration; direct keyboard Overview-to-Oblique switching passes; repetition remains `NOT_RUN` | Stable layout/obstacle IDs, schedule truth, delivered BT/recovery/trajectory evidence, artifact hashes, and explicit route-shape gates are ready for ecological episode design; explanation generation/annotation remains `NOT_RUN` | **REQUIRED — active ecological development; all eight motifs calibrated once, repetition open** |
