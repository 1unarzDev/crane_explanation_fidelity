...
| Configurable land proving ground | Existing corridor/blocker/timed-intervention mechanisms | Controlled recovery and failure mechanisms exist; requested multi-layout generator and route QA are incomplete | Controlled episodes exist; richer ecological cases not yet evaluated | **REQUIRED — active ecological development** |
