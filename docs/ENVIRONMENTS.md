...
| TurtleBot3 warehouse/industrial | Manifest-driven 20 × 26 m canonical geometry, separate presentation, semantic/route/scenario IDs, deterministic static/delayed/temporary obstacles, differential robot and LiDAR | Structural/physics/sensor/headless gates plus one 13.61 m west-aisle detour pass; isolated inspection passed; physical blockage and occupied-goal calibrations remained active until client cancellation under the stock continuously-replanning BT | Nominal and scenario evidence identities are ready; recovery/terminal-failure explanation evaluation is not yet run | **REQUIRED — active ecological development; nominal route ready, bounded failure/recovery suite incomplete** |
