...
error budget for one candidate revision and fresh replication. No campaign is active: P/R hashes,
surface strata, and a held-out-qualified Luna judge are not ready.

The historical 92-cluster calculation below tests improvement against zero under one fixed-look
