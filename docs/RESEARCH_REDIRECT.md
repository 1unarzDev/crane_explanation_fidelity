...
| Land geometry meaningfully affects behavior | Governed warehouse/proving-ground runs retain detour, blockage, recovery, trajectories and costmap summaries | Robot-visible geometric checks, successive-plan differences, diagnostic gold labels | Geometric-restriction and ambiguous-evidence pilots | Simulation behaviors are measured; physical cause is not yet diagnosed |
