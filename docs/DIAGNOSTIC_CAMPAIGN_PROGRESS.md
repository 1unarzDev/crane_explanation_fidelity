...
physical configurations collected are 9/64. Source-order run 041 adds a valid missing-odometry
...
persistent discrepancy followed by abort. Thus six
...
replication results remain zero. The next fixed configuration is `cm-land-conf-046`.
