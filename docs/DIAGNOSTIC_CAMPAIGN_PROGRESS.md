...
physical configurations collected are 8/64. Source-order run 041 adds a valid missing-odometry
...
a second independently configured instance of that contrast. Thus five
...
replication results remain zero. The next fixed configuration is `cm-land-conf-045`.
