...
The separate physical/reference cohort has attempted 24/100 fixed confirmation-side configurations:
24 valid, 0 invalid. The method-visible diagnostic dispositions are sixteen supported, five
