...
- **REFERENCE:** 0.260 versus 0.000 m/s over 10--20 s was followed by measured response recovery to
  0.25974 m/s (ratio 1.0000) over 23--24 s and eventual success. Two FollowPath failures and two
...
- **BOUNDARY:** event order does not prove recovery caused success or identify a unique physical
  cause. Registry-exact v3 dry run passed; no P/R response or Luna label was opened. Run 067 is next.

## 2026-09-26 — focused valid physical run 28 / source order 65: `cm-land-conf-065`

- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_PERSISTENT_DISCREPANCY_UNEXPECTED_ABORT_RESPONSE_UNOPENED`;
  one attempt, no replacement, unexpected abort retained, zero transport/Unity errors, all 14
  binding checks, and complete independent reference.
- **REFERENCE:** healthy motion was 0.25974 m/s; the event interval retained a 0.250 m/s delivered
  command versus 0.000 m/s odometry over 19--29 s, followed by abort. Three FollowPath attempts,
  two failures, and two source-qualified Wait starts are retained.
- **BOUNDARY:** the streams do not establish actuator acceptance, exact Nav2 odometry consumption,
  ...
  response or Luna label was opened. Run 066 is next.

## 2026-09-26 — focused valid physical run 27 / source order 64: `cm-land-conf-064`

- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_PERSISTENT_DISCREPANCY_UNEXPECTED_ABORT_RESPONSE_UNOPENED`;
  one attempt, no replacement, unexpected abort retained, zero transport/Unity errors, all 14
  binding checks, and complete independent reference.
- **REFERENCE:** healthy motion was 0.25974 m/s; the event interval retained a 0.260 m/s delivered
  command versus 0.000 m/s odometry over 10--20 s, followed by abort. Three FollowPath attempts,
  two failures, and two source-qualified Wait starts are retained.
- **BOUNDARY:** the streams do not establish actuator acceptance, exact Nav2 odometry consumption,
  the evaluator intervention, or a unique physical cause. Registry-exact v3 dry run passed; no P/R
  response or Luna label was opened. Run 065 is next.
...
- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_TRANSIENT_COMPENSATION_RESPONSE_UNOPENED`;
  one attempt, no replacement, successful navigation, zero transport/Unity errors, all 14 binding
  checks, and complete independent reference.
- **REFERENCE:** 0.260 versus 0.000 m/s over 18--27 s was followed by measured response recovery to
  0.25974 m/s (ratio 1.0000) over 30--31 s and eventual success. One FollowPath failure and one
  source-qualified Wait start are retained.
- **BOUNDARY:** event order does not prove recovery caused success or identify a unique physical
  cause. Registry-exact v3 dry run passed; no P/R response or Luna label was opened. Run 062 is next.

## 2026-09-26 — focused valid physical run 23 / source order 60: `cm-land-conf-060`

- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_PERSISTENT_DISCREPANCY_UNEXPECTED_ABORT_RESPONSE_UNOPENED`;
  one attempt, no replacement, unexpected abort retained, zero transport/Unity errors, all 14
  binding checks, and complete independent reference.
- **REFERENCE:** healthy motion was 0.25974 m/s; the event interval retained a 0.260 m/s delivered
  command versus 0.000 m/s odometry over 11--21 s, followed by abort. Three FollowPath attempts,
  two failures, and two source-qualified Wait starts are retained.
- **BOUNDARY:** the streams do not establish actuator acceptance, exact Nav2 odometry consumption,
  the evaluator intervention, or a unique physical cause. Registry-exact v3 dry run passed; no P/R
  response or Luna label was opened. Run 061 is next.

## 2026-09-26 — focused valid physical run 22 / source order 59: `cm-land-conf-059`
...
- **REFERENCE:** 0.260 versus 0.000 m/s over 18--27 s was followed by measured response recovery to
  ...
  source-qualified Wait start are retained.
- **BOUNDARY:** event order does not prove recovery caused success or identify a unique physical
  cause. Registry-exact v3 dry run passed; no P/R response or Luna label was opened. Run 060 is next.
...
- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_TRANSIENT_COMPENSATION_RESPONSE_UNOPENED`;
  one attempt, no replacement, successful navigation, zero transport/Unity errors, all 14 binding
  checks, and complete independent reference.
- **REFERENCE:** a later scheduled hold produced 0.260 versus 0.000 m/s over 18--27 s, followed by
  measured response recovery to 0.25974 m/s (ratio 1.0000) over 30--31 s and eventual success. One
  FollowPath failure and one source-qualified Wait start are retained.
- **BOUNDARY:** ordering does not prove recovery caused success or identify a unique physical cause.
  Registry-exact v3 dry run passed; no P/R response or Luna label was opened. Run 058 is next.
...
- **REFERENCE:** 0.260 versus 0.000 m/s over 11--21 s was followed by measured response recovery to
  0.25974 m/s (ratio 1.0000) over 23--24 s and eventual task success. One FollowPath failure and
  one source-qualified Wait start are retained.
- **BOUNDARY:** ordering does not prove that response recovery caused success or establish a unique
  physical/actuator cause. The registry-exact v3 reference dry run passed without invoking its
  nominal-only correction. No P/R response or Luna label was opened; run 056 is next.
...
- **REFERENCE:** 0.260 versus 0.000 m/s over 11--21 s was followed by measured response recovery to
  ...
  one source-qualified Wait start are retained.
- **BOUNDARY:** ordering does not prove that response recovery caused success or establish a unique
  physical/actuator cause. The registry-exact four-unit focused reference dry run passed. No P/R
  response or Luna label was opened; source-order `cm-land-conf-054` is next.
...
- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_TRANSIENT_COMPENSATION_RESPONSE_UNOPENED`;
  one attempt, no replacement, successful navigation, source/build qualification, zero Unity
  errors, all 14 binding checks, and complete independent reference.
- **REFERENCE:** 0.260 versus 0.000 m/s over 9--19 s was followed by measured response recovery to
  0.24975 m/s (ratio 0.9615) over 21--22 s and eventual task success. Two FollowPath failures and
  two source-qualified Wait starts are retained.
- **BOUNDARY:** ordering does not prove that response recovery caused success or establish a unique
  physical/actuator cause. No response or Luna label was opened; alpha 0.02 remains bound;
  source-order run `cm-land-conf-050` is next.
...
- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_DIAGNOSABLE_UNEXPECTED_ABORT_RESPONSE_UNOPENED`;
  ...
  zero-error Unity execution, all 14 binding checks, and independent-reference gates passed.
- **REFERENCE:** independent computation supports 0.260 m/s delivered command versus 0.000 m/s
  measured response over 9--19 s after a healthy 0.2597 m/s response. Navigation aborted after
  two FollowPath failures and two source-qualified Wait starts.
- **BOUNDARY:** this supports the discrepancy and recorded sequence, not actuator acceptance,
  Nav2 odometry consumption, the hidden intervention, or a unique physical cause. Responses remain
  unopened and alpha remains zero; source-order run `cm-land-conf-046` is next.
...
- **STATUS:** `VALID_FOCUSED_PHYSICAL_INDEPENDENT_PRIMARY_TRANSIENT_COMPENSATION_RESPONSE_UNOPENED`;
  one attempt and no replacement. The expected success, source-pinned zero-error Unity worker, all
  14 binding checks, and complete independent-reference gates passed.
- **REFERENCE:** independent low-speed computation supports a 0.260 versus 0.000 m/s discrepancy
  over 18--27 s after a healthy 0.2597 m/s response. Measured response recovered to 0.2597 m/s in
  30--31 s; navigation ultimately succeeded after one FollowPath failure and one source-qualified
  Wait invocation.
- **BOUNDARY:** this supports transient response loss, later measured recovery, and task success,
  not actuator acceptance, Nav2 consumption of odometry, the hidden intervention, or a unique
  physical cause.
- **GOVERNANCE:** robot-visible and evaluator-only roots were separately leakage/governance
  ...
  zero. Source-order run `cm-land-conf-044` is next.
...
- **ADMISSION:** exact player/build/catalog and all 14 scenario-binding checks passed for
  connected-detour 012 at seed 81011 without a mobility intervention; the worker and expected
  broad success outcome were valid.
- **OBSERVED / INDEPENDENT REFERENCE:** navigation succeeded after 89.110 s, three distinct
  delivered plans, two recovery-feedback cycles, 17.502 m displacement, and 1.558 m maximum
  lateral deviation. Independent calculations found a cost-254 direct-route intersection near
  x=11.525 m, a retained connection to the goal, and direct-to-nondirect plan changes.
- **BOUNDARY:** this is the third independent bounded navigation-model restriction pattern, not
  proof of global physical no-path, obstacle identity, exact Nav2 consumption, or snapshot-to-plan
  causation. Artifacts are governed and DVC-synchronized. Fixed command--motion run 4/5 is next;
...
- **REFERENCE:** proposed and independently implemented computations agree on an 18--28 s
  ...
  response recovered to 0.2597 m/s during 30--31 s, and the action succeeded after 80.960 s and
...
- **BOUNDARY:** this supports transient execution-response loss, later measured recovery, and task
  ...
  alpha use exists. Governed data are synchronized to R2; fixed run 040 is next.

## 2026-09-24 — land command--motion physical cohort run 038

- **STATUS:** `VALID TRANSIENT RESPONSE RECOVERY / SUCCESS / 38 ATTEMPTED / 37 VALID / 1 INVALID`.
  The sole fixed attempt passed exact build/binding, zero-error Unity-worker, expected-outcome, and
  complete independent-reference gates without retry.
- **REFERENCE:** proposed and independently implemented computations agree on a 19--29 s
  discrepancy at 0.260 versus 0.000 m/s after a 0--5 s healthy response of 0.2597 m/s. Measured
  response recovered to 0.2597 m/s during 31--32 s, and the action succeeded after 80.160 s and
  17.467 m, with two FollowPath attempts, one failure, and one source-qualified Wait invocation.
- **BOUNDARY:** this supports transient execution-response loss, later measured recovery, and task
  success—not actuator acceptance, Nav2 consumption of odometry, the hidden intervention, or a
  unique physical cause. No P/R response, Luna label, semantic effect, confidence sequence, or
  alpha use exists. Governed data are synchronized to R2; fixed run 039 is next.
...
- **STATUS:** `VALID TRANSIENT RESPONSE RECOVERY / SUCCESS / 37 ATTEMPTED / 36 VALID / 1 INVALID`.
  The sole fixed attempt passed exact build/binding, zero-error Unity-worker, expected-outcome, and
  complete independent-reference gates without retry.
- **REFERENCE:** proposed and independently implemented computations agree on a 10--22 s
  discrepancy at 0.260 versus 0.000 m/s after a 0--5 s healthy response of 0.2597 m/s. Measured
  response recovered to 0.2597 m/s during 22--23 s, and the action succeeded after 81.960 s and
  17.467 m, with two FollowPath attempts, one failure, and one source-qualified Wait invocation.
- **BOUNDARY:** this supports transient execution-response loss, later measured recovery, and task
  success—not actuator acceptance, Nav2 consumption of odometry, the hidden intervention, or a
  unique physical cause. No P/R response, Luna label, semantic effect, confidence sequence, or
  alpha use exists. Governed data are synchronized to R2; fixed run 038 is next.
...
- **REFERENCE:** proposed and independently implemented computations agree on an 11--21 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. Measured
  response recovered to 0.2298 m/s during 23--24 s, and the action succeeded after 92.260 s and
  17.505 m, with three FollowPath attempts, two failures, and two source-qualified Wait
  invocations.
- **BOUNDARY:** this supports transient execution-response loss, later measured recovery, and task
  success—not actuator acceptance, Nav2 consumption of odometry, the hidden intervention, or a
  unique physical cause. No P/R response, Luna label, semantic effect, confidence sequence, or
  alpha use exists. Governed data are synchronized to R2; fixed nominal run 036 is next.
...
- **STATUS:** `VALID NOMINAL NOT_TRIGGERED / SUCCESS / 33 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, zero-error Unity-worker, expected-outcome, and complete independent-
  reference gates without retry.
- **REFERENCE:** both implementations return `not_triggered` after a calibrated 0--5 s response of
  0.2597 m/s. The action succeeded after 85.710 s and 17.599 m even though the retained sequence
  contains three FollowPath attempts, two failures, and two source-qualified Wait invocations.
- **BOUNDARY:** recovery activity alone does not establish a command-to-motion discrepancy. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed transient-compensation run 034 is next.

## 2026-09-24 — land command--motion physical cohort run 032

- **STATUS:** `VALID PERSISTENT DISCREPANCY / ABORT / 32 OF 100 ATTEMPTED`. The sole fixed attempt
...
- **REFERENCE:** proposed and independently implemented computations agree on an 18--28 s
  ...
  aborted after 51.461 s and 4.747 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  ...
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed nominal run 033 is next.

## 2026-09-24 — land command--motion physical cohort run 031

- **STATUS:** `VALID TRANSIENT RESPONSE RECOVERY / SUCCESS / 31 OF 100 ATTEMPTED`. The sole fixed
...
- **REFERENCE:** proposed and independently implemented computations agree on a 19--28 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. Measured
  response recovered to 0.2597 m/s during 31--32 s, and the action succeeded after 81.160 s and
  17.492 m, with two FollowPath attempts, one failure, and one source-qualified Wait invocation.
- **BOUNDARY:** this supports transient execution-response loss, later measured recovery, and task
  success—not actuator acceptance, Nav2 consumption of odometry, the hidden intervention, or a
  unique physical cause. No P/R response, Luna label, semantic effect, confidence sequence, or
  alpha use exists. Governed data are synchronized to R2; fixed persistent run 032 is next.

## 2026-09-24 — land command--motion physical cohort run 030

- **STATUS:** `VALID PERSISTENT DISCREPANCY / ABORT / 30 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, zero-error Unity-worker, and complete independent-reference gates;
  the expected-success fixture mismatch is retained without retry.
- **REFERENCE:** proposed and independently implemented computations agree on an 18--39 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. The action
  aborted after 51.510 s and 4.520 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  Nav2 consumption of odometry, the hidden intervention, or a unique physical cause. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed transient-compensation run 031 is next.

## 2026-09-25 — land command--motion physical cohort run 029

- **STATUS:** `VALID INDEPENDENT AMBIGUITY CLUSTER / 29 OF 100 ATTEMPTED`. Exact build/binding,
  zero-error Unity-worker recording, v2 mask, independent ambiguity reference, and complete-reference
  audit passed. The scheduled persistent case aborted after 44.310 s and 2.714 m; this valid
  unexpected outcome is retained despite the generic fixture's success expectation.
- **RAW PHYSICAL AUDIT:** with odometry, independent computation supports an 11--20 s discrepancy at
  0.260 versus 0.000 m/s, followed by abort, three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **METHOD PACKET:** the sole future method-visible export contains 406 command samples and zero
...
- **SEMANTIC BOUNDARY:** no response, label, effect, interval, or alpha use. Governed data are
  synchronized to R2; fixed persistent-discrepancy run 030 is next.
...
- **REFERENCE:** proposed and independently implemented computations agree on an 11--21 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. The action
  aborted after 44.511 s and 2.726 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  Nav2 consumption of odometry, the hidden intervention, or a unique physical cause. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed masked-odometry run 028 is next.

## 2026-09-25 — land command--motion physical cohort run 026

- **STATUS:** `VALID TRANSIENT RESPONSE RECOVERY / SUCCESS / 26 OF 100 ATTEMPTED`. The sole fixed
  attempt passed exact build/binding, zero-error Unity-worker, expected-outcome, and complete
  independent-reference gates without retry.
- **REFERENCE:** proposed and independently implemented computations agree on an 18--28 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. Measured
  response recovered to 0.2597 m/s during 30--31 s, and the action succeeded after 94.960 s and
  17.598 m, with three FollowPath attempts, two failures, and two source-qualified Wait invocations.
- **BOUNDARY:** this supports transient execution-response loss, later measured recovery, and task
  success—not actuator acceptance, Nav2 consumption of odometry, the hidden intervention, or a
  unique physical cause. No P/R response, Luna label, semantic effect, confidence sequence, or
  alpha use exists. Governed data are synchronized to R2; fixed run 027 is next.

## 2026-09-25 — land command--motion physical cohort run 025

- **STATUS:** `VALID PERSISTENT DISCREPANCY / ABORT / 25 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, zero-error Unity-worker, and complete independent-reference gates;
  the expected-success fixture mismatch is retained without retry.
- **REFERENCE:** proposed and independently implemented computations agree on an 11--21 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. The action
  aborted after 44.510 s and 2.719 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  Nav2 consumption of odometry, the hidden intervention, or a unique physical cause. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed run 026 is next.
...
- **REFERENCE:** proposed and independently implemented computations agree on an 18--28 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. The action
  aborted after 51.261 s and 4.731 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  Nav2 consumption of odometry, the hidden intervention, or a unique physical cause. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed run 024 is next.

## 2026-09-25 — land command--motion physical cohort run 022

- **STATUS:** `VALID PERSISTENT DISCREPANCY / ABORT / 22 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, zero-error Unity-worker, and complete independent-reference gates;
  the expected-success fixture mismatch is retained without retry.
- **REFERENCE:** proposed and independently implemented computations agree on an 18--28 s
  discrepancy at 0.260 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. The action
  aborted after 51.710 s and 4.591 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  Nav2 consumption of odometry, the hidden intervention, or a unique physical cause. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed run 023 is next.

## 2026-09-25 — land command--motion physical cohort run 021

- **STATUS:** `VALID PERSISTENT DISCREPANCY / ABORT / 21 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, zero-error Unity-worker, and complete independent-reference gates;
  the expected-success fixture mismatch is retained without retry.
- **REFERENCE:** proposed and independently implemented computations agree on an 18--28 s
  discrepancy at 0.250 versus 0.000 m/s, after a 0--5 s healthy response of 0.2597 m/s. The action
  aborted after 40.511 s and 4.271 m, with three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **BOUNDARY:** this supports a sustained execution-response discrepancy, not actuator acceptance,
  Nav2 consumption of odometry, the hidden intervention, or a unique physical cause. No P/R
  response, Luna label, semantic effect, confidence sequence, or alpha use exists. Governed data
  are synchronized to R2; fixed run 022 is next.
...
- **STATUS:** `VALID PERSISTENT DISCREPANCY / ABORT / 17 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, the zero-error Unity-worker gate, robot-visible export, independent
  computation, and complete-reference audit. The unexpected abort is retained without replacement.
- **OBSERVED/REFERENCE:** the action aborted after 51.610 s and 4.549 m. Both implementations
  support an 18--28 s discrepancy at 0.260 versus 0.000 m/s, with three FollowPath attempts, two
  failures, and two source-qualified Wait invocations.
- **BOUNDARY:** no unique physical cause, semantic response, Luna label, effect, or alpha use.
  Governed data are synchronized to R2; 54 focused tests pass. Fixed ambiguity run 018 is next.

## 2026-09-24 — land command--motion physical cohort run 016

- **STATUS:** `VALID SUCCESSFUL TRANSIENT COMPENSATION / 16 OF 100 ATTEMPTED`. The sole fixed
  attempt passed all admission and independent-reference gates without retry or replacement.
- **OBSERVED/REFERENCE:** the action succeeded after 81.110 s and 17.491 m. Both implementations
  support an 11--20 s discrepancy at 0.260 versus 0.000 m/s and recovered response of 0.25974 m/s
  from 23--24 s, with two FollowPath attempts, one failure, and one qualified Wait.
- **BOUNDARY:** no unique physical cause, semantic response, Luna label, effect, or alpha use.
  Governed data are synchronized to R2; 52 focused tests pass. Fixed persistent run 017 is next.
...
- **OBSERVED/REFERENCE:** the action aborted after 51.610 s and 4.280 m. Both implementations
  support a 17--27 s discrepancy at 0.260 versus 0.000 m/s, with three FollowPath attempts, two
  failures, and two source-qualified Wait invocations.
- **BOUNDARY:** no unique physical cause, response, Luna label, semantic effect, or alpha use.
  Governed data are synchronized to R2; 52 focused tests and data governance pass. Fixed transient
  run 015 is next.

## 2026-09-24 — land command--motion physical cohort run 013

- **STATUS:** `VALID CLEAN NOMINAL NOT_TRIGGERED / 13 OF 100 ATTEMPTED`. The sole fixed attempt
  passed exact build/binding, the zero-error Unity-worker gate, robot-visible export, independent
  computation, and complete-reference audit. No retry or replacement occurred.
- **OBSERVED/REFERENCE:** the action succeeded after 69.160 s and 17.477 m with one FollowPath
  attempt, zero failures, and zero source-qualified Wait invocations. Both implementations return
  `not_triggered`.
- **BOUNDARY:** no response, Luna label, semantic effect, or alpha use. Governed data are
  synchronized to R2; 52 focused tests and data governance pass. Fixed persistent run 014 is next.
...
- **STATUS:** `VALID INDEPENDENT AMBIGUITY CLUSTER / 3 OF 100 ATTEMPTED`. Exact build/binding,
  zero-error Unity-worker recording, v2 mask, independent ambiguity reference, and complete-reference
  audit passed. The scheduled persistent case aborted after 51.210 s and 4.713 m; this valid
  unexpected outcome is retained despite the generic fixture's success expectation.
- **RAW PHYSICAL AUDIT:** with odometry, independent computation supports an 18--28 s discrepancy
  at 0.250 versus 0.000 m/s, followed by abort, three FollowPath attempts, two failures, and two
  source-qualified Wait invocations.
- **METHOD PACKET:** the sole future method-visible export contains 484 command samples and zero
  odometry samples. Its independently checked disposition is `insufficient`; the execution sequence
  remains answerable, but the discrepancy and unique physical cause must be withheld.
- **SEMANTIC BOUNDARY:** no response, label, effect, interval, or alpha use. Fixed transient run 004
  is next. See `cm-land-conf-003-disposition.json`.
...
## 2026-09-24 — diagnostic Unity-bundle preflight
