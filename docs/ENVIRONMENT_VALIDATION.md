...
| Warehouse/industrial ecological world | v2 manifest, 20 canonical boxes, eight regions, four route contracts; static contract passed | Historical basic collision/short-route checks; v2 route-specific physics gate not yet run | Headless ROS/LiDAR/odometry and populated costmaps passed during v2 calibration | **PARTIAL:** 13 m cross-aisle route timed out twice near the center divider; no validated detour/blockage suite | **PARTIAL / NOT_RUN** for required inspection tooling | v2 headless transport/runtime passed; navigation did not | **PARTIAL:** stable environment/route IDs exist; representative route outcome and evidence contract incomplete | Active highest-priority environment work |
