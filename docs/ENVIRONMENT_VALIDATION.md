...
| Warehouse/industrial ecological world | **PASS:** 20 canonical colliders, 20 separated renderers, 28 unique semantic IDs | **PASS:** drop/contact plus 0.150 m differential drive and 19.1° turn response | **PASS:** ROS/LiDAR/odometry, semantic hit on `rack-center-blocker`, populated costmaps | **PASS (nominal route only):** 13.61 m sampled west-aisle detour, 2.00 m lateral excursion, success in 54.63 s; recovery/blockage suite absent | **NOT_RUN** | **PASS:** matching manifest geometry and nominal route under null graphics | **PASS for nominal contract:** stable environment/route/object IDs and evidence highlighting; physical consumption claims remain bounded | **PARTIAL overall:** interactive and failure/recovery gates remain |
