...
| Warehouse/industrial ecological world | **PASS:** 20 nominal canonical colliders, 20 separated renderers, 28 unique nominal semantic IDs; four manifest scenario contracts | **PASS:** drop/contact plus 0.150 m differential drive and 19.1° turn response; scenario collider/visual state changes share fixed-time boundaries | **PASS:** ROS/LiDAR/odometry, semantic hit on `rack-center-blocker`, populated costmaps | **PASS:** nominal detour success; exact bounded-policy pair succeeded unobstructed in 53.38 s and aborted under complete blockage at the 70 s BT deadline before the 80 s client deadline. **RECOVERY NOT_RUN:** feedback remained zero recoveries | **PARTIAL:** isolated 1280×720 overview/oblique, HUD, semantic highlight, trajectory, and collider wireframes visually passed; manual keyboard polling not directly exercised | **PASS:** matching manifest v2.1.0 geometry and navigation under null graphics | **PASS for task-policy contract:** exact BT hash, action result, 629 delivered transitions, zero recovery count, and evaluator-only obstacle identity; terminal tick may be omitted and physical cause is not inferred | **PARTIAL overall:** genuine physical recovery scenario and full interactive check remain |
